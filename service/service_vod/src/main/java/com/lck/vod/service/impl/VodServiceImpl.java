package com.lck.vod.service.impl;
...
import com.lck.vod.Utils.ConstantVodUtils;
import com.lck.vod.Utils.InitObject;
...
public class VodServiceImpl implements VodService {
    ...
    public void removeAliyunVideobyId(String id) {
        try {
            ...
            throw new CustomerException(20001, "删除视频失败");
        }
    }
    ...
    public void removeMoreVideo(List<String> videoIdList) {
        ...
        try {
            ...
            throw new CustomerException(20001,"视频删除失败");
        }
    }
